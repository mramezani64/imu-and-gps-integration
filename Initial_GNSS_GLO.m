...
GNSS.posE   = zeros(1,4);
GNSS.posG   = zeros(1,4);
GNSS.time   = GNSS.Obs_data_R(GNSS.i,7);
GNSS.n_Sat  = GNSS.Obs_data_R(GNSS.i,8);
GNSS.sats   = GNSS.Obs_data_R(GNSS.i,9:9+GNSS.n_Sat-1)';
GNSS.Obs    = GNSS.Obs_data_R(GNSS.i,10+GNSS.n_Sat-1:10+GNSS.n_Sat*2-2)';
GNSS.Q      = [];
GNSS.n_SatV = [];
GNSS.n_Sat  = [];
GNSS.flg    = [];
